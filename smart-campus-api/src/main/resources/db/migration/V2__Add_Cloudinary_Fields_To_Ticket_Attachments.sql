...
ADD COLUMN IF NOT EXISTS cloudinary_url VARCHAR(1000),
ADD COLUMN IF NOT EXISTS cloudinary_secure_url VARCHAR(1000),
ADD COLUMN IF NOT EXISTS cloudinary_size BIGINT,
ADD COLUMN IF NOT EXISTS cloudinary_resource_type VARCHAR(100);
