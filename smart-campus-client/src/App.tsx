  ...
  return (
    <main className="mx-auto w-full max-w-5xl space-y-4 px-4 py-8">
      <section className="rounded-xl border border-[#d0d6e0] bg-[#ffffff] p-8">
        ...
        <h1 className="mt-2 text-3xl font-[590] tracking-[-0.044em]">Authentication, Settings and Resources</h1>
        <p className="mt-2 max-w-2xl text-sm text-[#62666d]">
          Welcome {user?.fullName ?? user?.email ?? "User"}. Use resources, profile, preferences, and admin tools from
          the top navigation.
        </p>
      </section>
    </main>
