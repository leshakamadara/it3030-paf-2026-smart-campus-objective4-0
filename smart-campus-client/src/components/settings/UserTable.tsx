  ...
  return (
    <div className="overflow-x-auto rounded-xl border border-white/8 bg-white/2">
      <table className="min-w-full text-left text-sm">
        <thead className="border-b border-white/8 bg-white/2 text-xs uppercase tracking-[0.12em] text-[#8a8f98]">
          <tr>
        ...
        <tbody>
          {filtered.map((user) => {
            ...
            return (
              <tr key={user.id} className="border-b border-white/6 bg-transparent">
