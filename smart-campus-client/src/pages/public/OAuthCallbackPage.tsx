...
export function OAuthCallbackPage() {
  ...
  return (
    <main className="grid min-h-svh place-items-center bg-[#08090a] px-6 text-[#f7f8f8]">
      <section className="w-full max-w-md rounded-xl border border-white/10 bg-[#0f1011] p-8 text-center">
        ...
        <p className="mt-2 text-sm text-[#8a8f98]">Please wait while we validate your campus session.</p>
      </section>
    </main>
  )
}
